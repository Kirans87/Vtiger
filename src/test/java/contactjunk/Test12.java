...
public static void main(String[] args) throws IOException, Exception {
		...
		// to delete existing contact for multiple runs of this script 
				try
				{
				driver.findElement(By.xpath("//table[@class='lvt small']//a[text()='piyush11']/../..//input")).click();
		...
		// creating contact 
		driver.findElement(By.name("lastname")).sendKeys("piyush11");
		...
		String expectedHeaderText = "piyush11 - Contact Information";
		...
		try
		{
		driver.findElement(By.xpath("//table[@class='lvt small']//a[text()='piyush11']"));
		//to verify Assigned To
		String assignedTo1 = driver.findElement(By.xpath("//table[@class='lvt small']//a[text()='piyush11']/../..//span[@vtfieldname='assigned_user_id']/..")).getText();
		if(assignedTo1.contains("Team Selling"))
			System.out.println("PASS : Contact is succesfully created and Assigned to Team Selling Group");
		else
			System.out.println("PASS : Contact is succesfully created but Not Assigned to Team Selling Group");
		}
	catch(NoSuchElementException n) 
		{
