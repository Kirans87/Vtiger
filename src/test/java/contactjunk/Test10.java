...
public static void main(String[] args) throws IOException, Exception {
		...
		// to delete existing contact for multiple runs of this script 
				try
				{
				driver.findElement(By.xpath("//table[@class='lvt small']//a[text()='piyush']/../..//input")).click();
		...
		// creating contact 
		driver.findElement(By.name("lastname")).sendKeys("piyush");
		...
		assignedTo.selectByVisibleText("Marketing Group");
		...
		String expectedHeaderText = "piyush - Contact Information";
		...
		try
		{
		driver.findElement(By.xpath("//table[@class='lvt small']//a[text()='piyush']"));
		
		//to verify Assigned To
		String assignedTo1 = driver.findElement(By.xpath("//table[@class='lvt small']//a[text()='piyush']/../..//span[@vtfieldname='assigned_user_id']/..")).getText();
		if(assignedTo1.contains("Marketing Group"))
			System.out.println("PASS : Contact is succesfully created and Assigned to Marketing Group");
		else
			System.out.println("PASS : Contact is succesfully created but Not Assigned to Marketing Group");
		}
	catch(NoSuchElementException n) 
		{
